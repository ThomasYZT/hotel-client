      ...
      <div class="flex-box">
        ...
        <div class="data-box right-box">
          ...
          <table-com v-if="showTable"
                     :data="tableData"
                     :config="memberRechargeTableConfig"
...
<script>
import { memberRechargeTableConfig } from './tableConfig.js';
  ...
  methods: {
    ...
    summaryHandler (param) {
      ...
      columns.forEach((column, index) => {
        if (index === 0) {
          sums[index] = '合计';
        } else if ([3, 4, 5, 6].includes(index)) {
    ...
    getList () {
      this.$ajax.get({
        apiKey: 'biGetTopUpConsumeCollect',
        params: {

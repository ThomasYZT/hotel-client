      ...
      <div class="flex-box">
        ...
        <div class="data-box right-box">
          ...
          <table-com v-if="showTable"
                     :data="tableData"
                     :config="creditCollectTableConfig"
            ...
            <template slot="col6"
              ...
              <el-table-column :prop="item.prop"
                ...
                <template slot-scope="{ row }">
                  <span>{{$util.toYuan(row.price) || 0}}</span>
                </template>
              </el-table-column>
            </template>
            <template slot="col7"
              ...
              <el-table-column :prop="item.prop"
                               ...
                               :min-width="item.minWidth">
                <template slot-scope="{ row }">
                  <span>{{settleStatusList.find(item => item.value === row.isPay) ?
                    settleStatusList.find(item => item.value === row.isPay).label : ''}}</span>
                </template>
              </el-table-column>
            </template>
          </table-com>
...
<script>
import { creditCollectTableConfig } from './tableConfig.js';
import { userType, settleStatusList } from '../../../assets/enums';
